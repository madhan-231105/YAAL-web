    ...
    <div className="bg-[#FCFBFA] min-h-screen pb-20 selection:bg-[#C5A02E]/20">
      ...
      <section className="relative h-[35vh] md:h-[45vh] flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: "url('https://images.unsplash.com/photo-1515562141207-7a88fb7ce338?q=80&w=2000')",
          }}
        />
        ...
        <div className="relative text-white text-center px-4">
          ...
          <h1 className="font-serif text-4xl md:text-6xl mt-3 tracking-tight">
            Bridal <span className="italic">Jewellery</span>
          </h1>
        </div>
      </section>
      ...
      <div className="max-w-[1800px] mx-auto px-4 lg:px-12 py-12">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <aside className="hidden lg:block w-[320px] p-10 bg-white rounded-2xl border border-gray-100 shadow-sm sticky top-10 h-fit space-y-12">
            <div>
              <h4 className="text-[11px] uppercase tracking-[0.3em] font-bold mb-6 text-gray-400">Search Catalogue</h4>
            ...
            <div>
              <h4 className="text-[11px] uppercase tracking-[0.35em] font-bold mb-6 text-gray-400">Collections</h4>
              ...
              {filteredItems.map(item => (
                ...
                >
                  ...
                  <div className="text-center mt-5 px-1">
                    ...
                    <h3 className="font-serif text-sm md:text-base text-gray-800 line-clamp-1 group-hover:text-[#C5A02E] transition-colors">
                      {item.name}
                    </h3>
                    ...
                    {/* NEW ENQUIRY BUTTON BELOW PRODUCT */}
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                      ...
                      className="mt-4 w-full border border-gray-200 py-2.5 rounded-lg text-[10px] font-bold uppercase tracking-[0.2em] text-gray-600 flex items-center justify-center gap-2 hover:bg-black hover:text-white hover:border-black transition-all duration-300"
                    >
                      <MessageCircle size={14} /> More Info 
                    </button>
                  </div>
                </motion.div>
              ))}
        ...
        {selectedItem && (
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-0 md:p-6 lg:p-12">
            ...
            >
              <button
                onClick={() => setSelectedItem(null)}
                className="absolute top-6 right-6 z-50 p-2 bg-white/10 hover:bg-black hover:text-white rounded-full transition-all text-gray-800"
              >
                <X size={24}/>
              </button>
              ...
              <div className="p-8 md:p-16 flex flex-col justify-center overflow-y-auto">
                <div className="mb-auto">
                  ...
                  <div className="flex items-baseline gap-2 mb-8 border-b border-gray-100 pb-8">
                    ...
                    <span className="text-gray-400 italic">/ daily rental</span>
                  </div>
                  <div className="space-y-6 mb-12">
                    <h4 className="flex items-center gap-2 text-xs font-bold text-gray-400 uppercase tracking-widest"><Info size={14}/> Product Info</h4>
                    <p className="text-gray-600 leading-relaxed text-lg">{selectedItem.description || "A masterfully crafted royal piece designed to elevate your bridal presence."}</p>
                  </div>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <button onClick={() => handleWhatsAppAction(selectedItem, "book")} className={`${goldBg} text-white py-5 rounded-2xl flex items-center justify-center gap-3 font-bold uppercase tracking-widest hover:brightness-110 transition shadow-xl shadow-[#C5A02E]/20`}><ShoppingBag size={20}/> Book Now</button>
                  <button onClick={() => handleWhatsAppAction(selectedItem, "enquiry")} className="bg-black text-white py-5 rounded-2xl flex items-center justify-center gap-3 font-bold uppercase tracking-widest hover:bg-gray-800 transition shadow-xl"><MessageCircle size={20}/> Send Enquiry</button>
                </div>
              </div>
            </motion.div>
          </div>
