...
export default function PlateDecoration() {
    ...
    <div className="font-sans bg-[#050505] text-[#F2F2F2]">
      ...
      <section className="relative h-[62vh] flex items-center justify-center overflow-hidden">
        ...
        <style>{`
          ...
          .hero-pop {
            animation: heroPop 1.7s cubic-bezier(0.2, 0.8, 0.2, 1) forwards;
          }
        `}</style>
        ...
        <div
          className={`relative z-10 text-center px-6 max-w-4xl mx-auto ${
            heroVisible ? "hero-pop" : "opacity-0"
          }`}
        >
      ...
      {/* IMAGE GRID */}
      <section id="collection" className="bg-[#F8F6F2] px-6 md:px-20 py-12 relative">
  <div className="text-center mb-8">
    ...
    <h2 className="text-4xl md:text-5xl font-serif text-[#111] mt-4">
      ...
      {/* PROCESS SECTION */}
      <section className="bg-[#111] text-[#F2F2F2] py-16 px-6 relative overflow-hidden">
      ...
      {active && (
        ...
        >
          <div
            ...
            className="relative bg-[#0A0A0A] rounded-2xl max-w-5xl w-full grid md:grid-cols-2 overflow-hidden shadow-2xl border border-[#222]"
          >
            <button
              onClick={() => setActive(null)}
              className="absolute top-4 left-4 z-50 w-10 h-10 rounded-full bg-black/50 text-white hover:bg-[#D4AF37] hover:text-black transition-all flex items-center justify-center"
            >
              ✕
            </button>
