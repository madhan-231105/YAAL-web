    ...
    this.program = new Program(this.gl, {
      ...
      vertex: `
        ...
        void main() {
          ...
          // --- FLATTENED: Removed the Sin/Cos Wave Logic ---
          // We kept the slight x-skew based on speed for momentum feel, 
          // but removed the Z manipulation.
...
createMedias(items, textColor, borderRadius, font) {
  ...
  update() {
    // --- AUTO SCROLL LOGIC ---
    if (!this.isDown) {
      // Increment target slowly when not dragging. 
      // Adjust "1.0" to change speed. "0.5" is slower, "2.0" is faster.
